...
@Component({
  selector: 'app-google-login-provider-config',
  templateUrl: './google-login-provider-config.component.html',
...
export class GoogleLoginProviderConfigComponent extends BaseComponent {
