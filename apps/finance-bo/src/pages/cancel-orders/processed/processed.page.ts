...
@Component({
  selector: 'mix-finance-cancel-orders-page-processed',
...
export class FinanceVoidBillProcessed extends BasePageComponent {
  ...
  constructor() {
    ...
    this.event.opened({
      query: new IGetPosRequest({
        statuses: [ENotificationStatus.Proccessed],
